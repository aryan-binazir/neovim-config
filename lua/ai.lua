...
-- Yank selection with file path, line numbers, and code
...
vim.keymap.set('n', '<leader>cc', function()
    vim.fn.system('tmux split-window -h -c ' .. vim.fn.shellescape(vim.fn.getcwd()) .. [[ 'bash -ic cc']])
end, { desc = 'Open Claude Code in tmux split' })

vim.keymap.set('n', '<leader>cur', function()
    vim.fn.system('tmux split-window -h -c ' .. vim.fn.shellescape(vim.fn.getcwd()) .. [[ 'bash -ic cur']])
